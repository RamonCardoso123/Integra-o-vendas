...
DROP TRIGGER IF EXISTS set_updated_at_contas_pagar ON public.contas_pagar_importadas;
...
DROP POLICY IF EXISTS "usuarios_veem_seus_vinculos" ON public.usuarios_empresas;
CREATE POLICY "usuarios_veem_seus_vinculos"
  ON public.usuarios_empresas FOR SELECT
  USING (user_id = auth.uid());

DROP POLICY IF EXISTS "usuarios_inserem_vinculos" ON public.usuarios_empresas;
...
DROP POLICY IF EXISTS "logs_insert_service" ON public.logs_integracao;
...
-- ============================================================
-- ARQUIVO: 002_add_doc_emissao.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 003_fornecedores_contaazul.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 004_fix_rls_empresas.sql
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 005_add_conta_financeira.sql
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 006_add_email_login_empresa.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 007_add_conta_financeira_id.sql
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 009_add_fornecedor_id.sql
-- ============================================================
ALTER TABLE contas_pagar_importadas ADD COLUMN IF NOT EXISTS fornecedor_id TEXT;


-- ============================================================
-- ARQUIVO: 010_remove_rls_isolation.sql
-- ============================================================


-- ============================================================
-- ARQUIVO: 011_revert_rls_isolation.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 012_vendas_importadas.sql
-- ============================================================
-- ============================================================
...
DROP TRIGGER IF EXISTS set_updated_at_vendas_importadas ON public.vendas_importadas;
...
-- ============================================================
-- ARQUIVO: 013_add_tipo_empresa.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 014_fornecedor_depara.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 015_add_datacar_credentials.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 016_add_metadata_to_importadas.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 017_add_unique_constraints_to_importadas.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 018_add_categoria_to_contas_pagar.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 018_memoria_fiscal.sql
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 019_memoria_fiscal_familia.sql
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 020_empresa_config_fiscal.sql
-- ============================================================
...
DROP TRIGGER IF EXISTS update_empresa_config_fiscal_modtime ON public.empresa_config_fiscal;
...
DROP POLICY IF EXISTS "Permitir upload de certificado para usuario autenticado" ON storage.objects;
...
DROP POLICY IF EXISTS "Permitir gerenciar proprio certificado" ON storage.objects;
...
-- ============================================================
-- ARQUIVO: 021_add_aliquotas_fiscais.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 023_fornecedores_contaazul_unique.sql
-- ============================================================
-- ============================================================
...
-- ============================================================
-- ARQUIVO: 024_fix_rls_fornecedor_depara.sql
-- ============================================================
-- ============================================================
